...
export default {
		...
		monsters: [
			{
				...
				beforeImage : require('../assets/before.png'),
	...
	methods: {
		addRealMonster() {
			...
			// 무엇을 어떻게 해야할까요?
			this.monsters.push({ name: '새 몬스터', age: 20, desc: '새로 생긴 몬스터예요.',beforeImage : require('../assets/before.png'), afterImage : require('../assets/after.png'), stateTxt : '안죽었다', hp : 100, isDied : false })
