<template>
	<div class="monster">
		...
		-->
		<MonsterList :monsters="monsters" @add="addRealMonster" @pop="popRealMonster"/>
		<MonsterModal :monsters="monsters" :clickCnt="clickCnt" @close="modalCloseFunc" />
...
export default {
	...
	methods: {
		...
		popRealMonster(target, idx) {
			target.isShow = true;
			this.clickCnt = idx;

		}, 
		modalCloseFunc(target) {
			target.isShow = false;
		}
	}
}
