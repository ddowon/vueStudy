<template>
	<div class="dim-wrap on" style="display: block;">
		<!-- 레이어팝업 보임 : on -->
		<div class="dim-con sign-form-wrap">
			<form class="sign-form">
				<h3 class="form-title"><span>회원가입</span><button type="button">×</button></h3>
				...
				<div class="form-group -inline">
					...
					<input type="name" v-model="name" placeholder="Name" class="input">
				</div>
				<div class="form-group -inline">
				...
				<div class="form-actions">
					<button type="submit" class="button primary -full" @click.prevent="signUp">가입하기</button>
				</div>
				<div class="form-footer">
					<div class="control-group">
						<button type="button" class="button link">이미 계정이 있어요!</button>
					</div>
				</div>
			</form>
		</div>
