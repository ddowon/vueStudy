...
.modal .modal-btn-close {position:absolute;display:block;overflow:hidden;top:-46px;right:0;width:34px;height:34px;text-indent:-9999px;font-size:0;background:url('http://s.nx.com/s2/game/sky/event/200206_vtday_11i15/btns/btn_close.png') no-repeat 0 0;cursor:pointer;outline:none}
